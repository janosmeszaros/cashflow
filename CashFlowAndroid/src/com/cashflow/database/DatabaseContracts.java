...
public final class DatabaseContracts {
    ...
    public static final class AbstractStatement implements BaseColumns {
        ...
        public static final String SELECT_STATEMENT_BY_ID = SELECT + TABLE_NAME + DOT + _ID + AS_STR + STATEMENT_ID_ALIAS + COMMA_SEP
                + AbstractCategory.TABLE_NAME + DOT + _ID + AS_STR + AbstractCategory.CATEGORY_ID_ALIAS + COMMA_SEP + COLUMN_NAME_AMOUNT + COMMA_SEP
    ...
    public static final class AbstractBill implements BaseColumns {
        ...
        public static final String STATEMENT_INNER_JOINED_CATEGORY = TABLE_NAME + " LEFT JOIN " + AbstractCategory.TABLE_NAME + " ON " + TABLE_NAME
                + DOT + COLUMN_NAME_CATEGORY + "=" + AbstractCategory.TABLE_NAME + DOT + AbstractCategory._ID;
        public static final String[] PROJECTION = new String[]{TABLE_NAME + DOT + _ID + AS_STR + BILL_ID_ALIAS,
            AbstractCategory.TABLE_NAME + DOT + _ID + AS_STR + AbstractCategory.CATEGORY_ID_ALIAS, COLUMN_NAME_AMOUNT, COLUMN_NAME_DATE_ADDED,
            COLUMN_NAME_DATE_PAYED, AbstractCategory.COLUMN_NAME_CATEGORY_NAME, COLUMN_NAME_DATE_DEADLINE, COLUMN_NAME_NOTE, COLUMN_NAME_IS_PAYED};

...
public final class DatabaseContracts {
    ...
    public static final class AbstractCategory implements BaseColumns {
        ...
        public static final String SQL_CREATE_ENTRIES = CREATE_TABLE + TABLE_NAME + OPEN_PARENTHESIS + _ID + INTEGER_TYPE + PRIMARY_KEY
                + COMMA_SEP
    ...
    public static final class AbstractStatement implements BaseColumns {
        ...
        public static final String[] PROJECTION = new String[] { _ID, COLUMN_NAME_AMOUNT, AbstractCategory.COLUMN_NAME_CATEGORY_NAME,
            COLUMN_NAME_DATE,
        ...
        public static final String[] PROJECTION_WITH_ALIAS = new String[] { TABLE_NAME + DOT + _ID + AS_STR + STATEMENT_ID_ALIAS,
            AbstractCategory.TABLE_NAME + DOT + _ID + AS_STR + AbstractCategory.CATEGORY_ID_ALIAS, COLUMN_NAME_AMOUNT,
            AbstractCategory.COLUMN_NAME_CATEGORY_NAME, COLUMN_NAME_DATE, COLUMN_NAME_NOTE, COLUMN_NAME_INTERVAL, COLUMN_NAME_IS_INCOME };

        public static final int[] TO_VIEWS = { R.id.row_id, R.id.row_amount, R.id.row_category, R.id.row_date, R.id.row_note,
            R.id.row_interval };
        ...
        public static final String RECURRING_INCOME_SELECTION = OPEN_PARENTHESIS + COLUMN_NAME_IS_INCOME + EQUALS_INCOME + AND
        ...
        public static final String SQL_CREATE_ENTRIES = CREATE_TABLE + TABLE_NAME + OPEN_PARENTHESIS + _ID + " INTEGER PRIMARY KEY"
                + COMMA_SEP
                + COLUMN_NAME_CATEGORY + INTEGER_TYPE + COMMA_SEP + COLUMN_NAME_AMOUNT + REAL_TYPE + COMMA_SEP + COLUMN_NAME_IS_INCOME
                + INTEGER_TYPE
                + COMMA_SEP + COLUMN_NAME_DATE + TEXT_TYPE + COMMA_SEP + COLUMN_NAME_INTERVAL + TEXT_TYPE + COMMA_SEP + COLUMN_NAME_NOTE
                + TEXT_TYPE
    ...
    public static final class AbstractBill implements BaseColumns {
        ...
        public static final String[] PROJECTION_WITH_ALIAS = new String[] { TABLE_NAME + DOT + _ID + AS_STR + BILL_ID_ALIAS,
            AbstractCategory.TABLE_NAME + DOT + _ID + AS_STR + AbstractCategory.CATEGORY_ID_ALIAS, COLUMN_NAME_AMOUNT,
        ...
        public static final String SQL_CREATE_ENTRIES = CREATE_TABLE + TABLE_NAME + OPEN_PARENTHESIS + _ID + " INTEGER PRIMARY KEY,"
                ...
                + COLUMN_NAME_DATE_DEADLINE
                + TEXT_TYPE + COMMA_SEP + COLUMN_NAME_DATE_PAYED + TEXT_TYPE + COMMA_SEP + COLUMN_NAME_CATEGORY + TEXT_TYPE + COMMA_SEP
                + COLUMN_NAME_IS_PAYED + INTEGER_TYPE + COMMA_SEP + COLUMN_NAME_NOTE + TEXT_TYPE + COMMA_SEP + COLUMN_NAME_INTERVAL
                + TEXT_TYPE
                + CLOSE_PARENTHESIS;

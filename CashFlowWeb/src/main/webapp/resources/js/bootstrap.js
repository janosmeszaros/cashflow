...
!function($) {
	...
	$(document).on('click.dropdown.data-api', clearMenus).on(
		...
		e.stopPropagation()
	}).on('click.dropdown.data-api', toggle, Dropdown.prototype.toggle).on(
			'keydown.dropdown.data-api', toggle + ', [role=menu]',
			Dropdown.prototype.keydown)

}(window.jQuery);
/*
 * ========================================================= bootstrap-modal.js
 * v2.3.1 http://twitter.github.com/bootstrap/javascript.html#modals
 * ========================================================= Copyright 2012
 * Twitter, Inc.
 * 
 ...
 * http://twitter.github.com/bootstrap/javascript.html#tooltips Inspired by the
...
!function($) {
	...
	Tooltip.prototype = {
		...
		getOptions : function(options) {
			options = $.extend({}, $.fn[this.type].defaults, this.$element
					.data(), options)
		...
		,
		toggle : function(e) {
			var self = e ? $(e.currentTarget)[this.type](this._options).data(
					this.type) : this
...
!function($) {
	...
	Popover.prototype = $.extend({}, $.fn.tooltip.Constructor.prototype, {
		...
		getContent : function() {
			...
			content = (typeof o.content == 'function' ? o.content.call($e[0])
					: o.content)
					|| $e.attr('data-content')
			...
			$targets = this.$body.find(this.selector).map(
					function() {
						...
						return ($href && $href.length && [ [
								$href.position().top
										+ (!$.isWindow(self.$scrollElement
												.get(0)) && self.$scrollElement
												.scrollTop()), href ] ])
								|| null
					}).sort(function(a, b) {
				return a[0] - b[0]
...
/*
 * ========================================================== bootstrap-affix.js
 * v2.3.1 http://twitter.github.com/bootstrap/javascript.html#affix
 * ========================================================== Copyright 2012
 * Twitter, Inc.
 * 
 * Licensed under the Apache License, Version 2.0 (the "License"); you may not
...
!function($) {
	...
	var Affix = function(element, options) {
		...
		this.$window = $(window).on('scroll.affix.data-api',
				$.proxy(this.checkPosition, this)).on('click.affix.data-api',
				$.proxy(function() {
